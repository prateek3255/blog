...
import img1_cookie_sent_to_server_with_headers from './cookie-sent-to-server-with-headers.png';
import img2_cookie_domain_attribute from './cookie-domain-attribute.png';
import img3_cookie_httponly_attribute from './cookie-httponly-attribute.png';
import img4_cookie_samesite_attribute from './cookie-samesite-attribute.png';
...
<BlogImage src={img1_cookie_sent_to_server_with_headers} alt="Cookies being sent to the server with request headers" />
...
<BlogImage src={img2_cookie_domain_attribute} alt="Domain attribute allowing cookies to be accessed via subdomains" />
...
<BlogImage src={img3_cookie_httponly_attribute} alt="HTTPOnly attribute example" />
...
<BlogImage src={img4_cookie_samesite_attribute} alt="SameSite attribute with Strict" />
