...
import img1_prototypes_in_console from './prototypes-in-console.png';
import img2_prototypes_getprototypeof from './prototypes-getprototypeof.png';
import img3_prototypes_object_visualization from './prototypes-object-visualization.png';
import img4_prototypes_car_example_visualization from './prototypes-car-example-visualization.png';
import img5_prototypes_constructor_function_example from './prototypes-constructor-function-example.png';
import img6_prototypes_constructor_function_visualization from './prototypes-constructor-function-visualization.png';
import img7_prototypes_object_created_with_constructor_function from './prototypes-object-created-with-constructor-function.png';
import img8_prototypes_chaining_visualization from './prototypes-chaining-visualization.png';
import img9_prototypes_prototypal_inheritance_visualization from './prototypes-prototypal-inheritance-visualization.png';
...
<BlogImage src={img1_prototypes_in_console} alt="The prototype visible under [[Prototype]] in console" />
...
<BlogImage src={img2_prototypes_getprototypeof} alt="The object prototype with Object.getPrototypeOf" />

Here is a visualization to help you understand how it works:

<BlogImage src={img3_prototypes_object_visualization} alt="Object prototype visualization" />
...
<BlogImage src={img4_prototypes_car_example_visualization} alt="Object.create visualization" />
...
<BlogImage src={img5_prototypes_constructor_function_example} alt="Constructor function example" />
...
<BlogImage src={img6_prototypes_constructor_function_visualization} alt="Constructor function visualization" />
...
<BlogImage src={img7_prototypes_object_created_with_constructor_function} alt="Object created with constructor function" />
...
<BlogImage src={img8_prototypes_chaining_visualization} alt="Prototype chaining" />
...
<BlogImage src={img9_prototypes_prototypal_inheritance_visualization} alt="Prototypal inheritance example" />
