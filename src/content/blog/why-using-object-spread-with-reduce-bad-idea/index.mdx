...
import img1_comparison_computational_complexity from './comparison-computational-complexity.png';
...
<BlogImage src={img1_comparison_computational_complexity} alt="Comparing computational complexity of different Big O notations" />
