...
import img1_future_of_rendering_csr_network_graph from './future-of-rendering-csr-network-graph.png';
import img2_future_of_rendering_ssr_network_graph from './future-of-rendering-ssr-network-graph.png';
import img3_future_of_rendering_ssg_isr_network_graph from './future-of-rendering-ssg-isr-network-graph.png';
import img4_future_of_rendering_max_stoiber_streaming_netwrok_graph from './future-of-rendering-max-stoiber-streaming-netwrok-graph.png';
import img5_future_of_rendering_streaming_ssr_with_suspense_network_graph from './future-of-rendering-streaming-ssr-with-suspense-network-graph.png';
...
<iframe width="535" height="367" src="https://www.youtube.com/embed/6wsw6eKdIOM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</Callout>
...
<VideoPlayer src="/videos/future-of-rendering-csr-demo.webm" />

And hence this is the network graph:

<BlogImage src={img1_future_of_rendering_csr_network_graph} alt="Client side rendering network graph" />
...
```
<VideoPlayer src="/videos/future-of-rendering-ssr-demo.webm" />

And hence this leads to the following network graph:

<BlogImage src={img2_future_of_rendering_ssr_network_graph} alt="Server side rendering network graph" />
...
<BlogImage src={img3_future_of_rendering_ssg_isr_network_graph} alt="Static Site generation/Incremental Static regeneration network graph" />
...
<BlogImage src={img4_future_of_rendering_max_stoiber_streaming_netwrok_graph} alt="Max Stoiber's illustration of how renderToNodeStream is different from renderToString" />
...
<VideoPlayer src="/videos/future-of-rendering-streaming-ssr-with-suspense-demo.webm" />



This leads to a network graph that looks something like this:

<BlogImage src={img5_future_of_rendering_streaming_ssr_with_suspense_network_graph} alt="Streaming SSR with Suspense network graph" />
...
<VideoPlayer src="/videos/future-of-rendering-server-components-demo.webm" />
