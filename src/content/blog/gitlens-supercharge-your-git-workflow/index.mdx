...
import img1_gitlens_line_blame_default from './gitlens-line-blame-default.jpg';
import img3_gitlens_commit_options from './gitlens-commit-options.jpg';
import img6_gitlens_switch_to_commit from './gitlens-switch-to-commit.jpg';
import img7_gitlens_file_heatmap from './gitlens-file-heatmap.jpg';
...
<BlogImage src={img1_gitlens_line_blame_default} alt="GitLens line blame default view" />
...
<img src="/images/gitlens-supercharge-your-git-workflow/gitlens-open-changes-line-blame.gif" alt="GitLens line blame open changes" />
...
<BlogImage src={img3_gitlens_commit_options} alt="GitLens commit options" />
...
<img src="/images/gitlens-supercharge-your-git-workflow/gitlens-file-blame.gif" alt="GitLens file blame" />
...
<img src="/images/gitlens-supercharge-your-git-workflow/gitlens-commit-view.gif" alt="GitLens commits view" />
...
<BlogImage src={img6_gitlens_switch_to_commit} alt="GitLens switch to commit" />
...
<BlogImage src={img7_gitlens_file_heatmap} alt="GitLens file heatmap" />
...
<img src="/images/gitlens-supercharge-your-git-workflow/gitlens-interactive-rebase.gif" alt="GitLens interactive rebase" />
