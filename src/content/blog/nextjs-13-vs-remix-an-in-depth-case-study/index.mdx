...
import img1_twitter_clone_user_profile_page from './twitter-clone-user-profile-page.png';
import img2_remix_layout_for_user_profile_page from './remix-layout-for-user-profile-page.png';
import img3_nextjs_layout_for_user_profile_page from './nextjs-layout-for-user-profile-page.png';
import img4_remix_network_graph from './remix-network-graph.png';
import img5_nextjs_server_and_client_component from './nextjs-server-and-client-component.png';
import img6_nextjs_server_and_client_components_comparision_table from './nextjs-server-and-client-components-comparision-table.png';
import img7_streaming_with_suspense from './streaming-with-suspense.png';
import img8_nextjs_streaming_with_suspense from './nextjs-streaming-with-suspense.png';
import img9_remix_full_stack_data_flow from './remix-full-stack-data-flow.png';
import img10_nextjs_error_boundary from './nextjs-error-boundary.png';
...
<BlogImage src={img1_twitter_clone_user_profile_page} alt="Twitter Clone User Profile Page" />
...
<BlogImage src={img2_remix_layout_for_user_profile_page} alt="Remix Layout for User Profile Page" />
...
<BlogImage src={img3_nextjs_layout_for_user_profile_page} alt="Next.js Layout for User Profile Page" />
...
<VideoPlayer src="/videos/remix-parallel-loaders-demo.webm" />

And this is how the Network graph looks for the Remix Twitter Clone as well:

<BlogImage src={img4_remix_network_graph} alt="Remix Parallel Loaders Network Graph for the User Profile page on the Twitter Clone app" />
...
<BlogImage src={img5_nextjs_server_and_client_component} alt="Next.js Server and Client Components Composition for the User Profile page" />
...
<BlogImage src={img6_nextjs_server_and_client_components_comparision_table} alt="Next.js Server and Client Components Composition Comparison table" />
...
<BlogImage src={img7_streaming_with_suspense} alt="Streaming with Suspense" />
...
<VideoPlayer src="/videos/remix-streaming-demo.webm" />
...
<BlogImage src={img8_nextjs_streaming_with_suspense} alt="Next.js Streaming with Suspense" />
...
<BlogImage src={img9_remix_full_stack_data_flow} alt="Remix Full Stack Data Flow" />
...
<VideoPlayer src="/videos/tweet-like-remix.webm" />
...
<VideoPlayer src="/videos/remix-form-errors-without-js.webm" />

And another example of following a user from the user profile page:

<VideoPlayer src="/videos/remix-follow-user-without-js.webm" />
...
<VideoPlayer src="/videos/nextjs-unfollow-demo.webm" />
...
<VideoPlayer src="/videos/nextjs-routing-demo.webm" />
...
<VideoPlayer src="/videos/remix-routing-demo.webm" />
...
<BlogImage src={img10_nextjs_error_boundary} alt="Next.js Error Boundary" />
